...
5. SSH into your Unraid server or open a terminal session from the Unraid UI and run `wget "https://raw.githubusercontent.com/lnxd/unraid-templates/main/PhoenixMiner-AMD.xml" -O "/boot/config/plugins/dockerMan/templates-user/my-PhoenixMiner-AMD-lnxd.xml"`
